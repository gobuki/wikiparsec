...
shuiEntry :: Text
shuiEntry = unlines [
    "== 水 ({{Sprache|Chinesisch}}) ==",
    "=== {{Wortart|Schriftzeichen|Chinesisch}} ===",
    "{{Chinesisch Übersicht|",
    " Alternative Schreibweisen=",
    "|Bedeutung=[[Wasser]], [[Flüssigkeit]], [[Saft]]",
    "|Bild=水-bw.png",
    "|Herkunft=Ein Trigramm des I-Gings mit der Bedeutung \"Wasser\" ¦I¦",
    "|Gegenwörter=",
    "|Abgeleitete Schriftzeichen=",
    "|Unicode=6C34",
    "|Radikal=水",
    "|Zusatzstriche=0 (Nummer 85)",
    "|Strichzahl=4",
    "|Viereckenindex=1223<sub>0</sub>",
    "|CangJie=水 (E)",
    "}}",
    "",
    ...
    "",
    "{{Umschrift}}",
    ":* [[Hilfe:Pinyin]]: [[shui|shuǐ]] (shui3)",
    ":* [[Hilfe:Wade-Giles|Wade-Giles]]: shui<sup>3</sup>",
    "",
    "{{Aussprache}}",
    ":{{IPA}} {{Lautschrift|ʂu̯èɪ̯}}",
    ":{{Hörbeispiele}} {{Audio|zh-shuǐ.ogg}}",
    "",
    "{{Bedeutungen}}",
    ":[1] [[Wasser]]",
    ":[2] [[Flüssigkeit]]",
    ...
    "==== {{Übersetzungen}} ====",
    "{{Ü-Tabelle|Ü-links=",
    "*{{de}}: [1] {{Ü|de|Wasser}}; [2] {{Ü|de|Flüssigkeit}}; [3] {{Ü|de|Saft}}",
    "*{{en}}: [1] {{Ü|en|water}}; [2] {{Ü|en|liquid}}",
    "*{{fr}}: [1] {{Ü|fr|eau}}; [2] {{Ü|fr|liquide}}",
    "|Ü-rechts=",
    "*{{it}}: [1] {{Ü|it|acqua}}; [2] {{Ü|it|liquido}}",
    "*{{es}}: [1] {{Ü|es|agua}}; [2] {{Ü|es|líquido}}",
    "}}",
    "",
    "{{Referenzen}}",
    ":[1–3] {{Wikipedia|spr=zh|水}}",
    "",
    "== 水 ({{Sprache|Japanisch}}) ==",
    "=== [[Hilfe:Chinesisches Schriftzeichen|Kanji]] ===",
    "",
    "{{Kanji-Tabelle|",
    " Radikal=水",
    "|Strichzahl=4",
    "|On-Lesung (Hiragana)=スイ",
    "|On-Lesung (Latein)=SUI",
    "|Kun-Lesung (Hiragana)=みず",
    "|Kun-Lesung (Latein)=mizu",
    "|Namen=",
    "}}",
    "",
    "{{Umschrift}}",
    "*[[Hilfe:On-Lesung|On-Lesung]]: すい &rarr; [[Hilfe:Kunrei-System|Kunrei]], [[Hilfe:Hepburn-System|Hepburn]]: sui",
    "*[[Hilfe:Kun-Lesung|Kun-Lesung]]: みず &rarr; [[Hilfe:Kunrei-System|Kunrei]], [[Hilfe:Hepburn-System|Hepburn]]: mizu",
    "",
    "{{Absatz}}",
    "",
    "=== {{Wortart|Substantiv|Japanisch}}, みず ===",
    "",
    "{{Umschrift}}",
    ":[[Hilfe:Kunrei-System|Kunrei]]: mizu",
    ":[[Hilfe:Hepburn-System|Hepburn]]: [[mizu]]",
    "",
    "{{Aussprache}}",
    ":{{IPA}} {{Lautschrift|mʲi↓(d)zɯ}}",
    "",
    "{{Bedeutungen}}",
    ":[1] [[Wasser]]",
    "",
    ...
    ":[1] {{Wikipedia|Wasser}}",
    "",
    "{{Kanji-Index|4|水|00|スイ}}",
    "",
    "== 水 ({{Sprache|Koreanisch}}) ==",
    "=== {{Schriftzeichen|Hanja}} ===",
    "",
    ":'''[[Hilfe:Hangeul|Hangeul]]:''' 수",
    ":'''[[Hilfe:Huneum|Huneum]]:''' 물 수",
    "",
    "{{Lemmaverweis|수}}",
    "",
    "{{Referenzen}}",
...
shuiFacts :: [WiktionaryFact] 
shuiFacts = [
  WiktionaryFact "definition" (term ["水","zh","n","","def.1"]) (term ["Wasser","de"]),
  WiktionaryFact "link" (term ["水","zh","n","","def.1"]) (term ["Wasser"]),
  WiktionaryFact "definition" (term ["水","zh","n","","def.2"]) (term ["Flüssigkeit","de"]),
  WiktionaryFact "link" (term ["水","zh","n","","def.2"]) (term ["Flüssigkeit"]),
  WiktionaryFact "definition" (term ["水","zh","n","","def.3"]) (term ["Saft","de"]),
  WiktionaryFact "link" (term ["水","zh","n","","def.3"]) (term ["Saft"])
  ]
...
entryTestsCats = compareLists "Example entry for 'Katze'" (deParseWiktionary (const . const True) "Katze" catEntry) catFacts
entryTestsShui = compareLists "Example entry for '水'" (deParseWiktionary (\l c -> l == "zh") "水" shuiEntry) shuiFacts

tests = test $ entryTestsCats ++ entryTestsShui
